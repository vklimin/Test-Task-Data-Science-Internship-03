...
* ❌ У моделей должен быть разный таргет для обучении
...
📌 На грани: можно считать частично верным, но **лучше интерпретировать как часть идеи "разнообразия"**.  
➡️ Тем не менее, если понимать "разная дисперсия" как признак **разных типов моделей или подходов**, то такой ансамбль будет работать лучше.  
👉 Поэтому **в контексте теста — принимается как допустимо верный**.
...
📌 Пример: блендинг/стекинг строят только на моделях, которые уже показали хорошую метрику на валидации.
