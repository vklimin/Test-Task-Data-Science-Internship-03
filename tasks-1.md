...
👉 mean(abs(SHAP)) по каждому признаку — отличный способ определить, какие признаки **наиболее влияют на предсказания модели**.
...
* ✅ У моделей должна быть низкая ошибка предсказания
